...
/* Beispielformeln für DREIwertige Logik */

example_F(b(1), (~-a)).
example_F(b(2), (a v ~-b & ~-c & d)).
example_F(b(3), (a & -b v ~-c & -d v ~-e)).
example_F(b(4), (~-a > b v ~-c)).
example_F(b(5), (f & ~-b <> h v -a)).
example_F(b(6), ((bw <> (aw <> -aw)) & (cw <> (- bw & aw))) & bw).


/* Beispielformeln für ZWEIwertige Logik*/
